...
def select_max_incremental_item(select_items, all_items, layer, estimater):
    ...
    for item in all_items[layer]:
        ...
        record_data("data/compatibility.txt", compatibility_score)
        record_data("data/versatility.txt", versatility_score)
        record_data("data/simirality.txt", simirality_score)
        record_data("data/multiply.txt", multiply_score)
